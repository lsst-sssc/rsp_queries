...
class TestQuery:
    ...
    def test_centaurs(self):
        expected_query = f"""SELECT a FROM dp03_catalogs_10yr.MPCORB as mpc
    ...
    def test_mbas(self):
        expected_query = f"""SELECT a, q FROM dp03_catalogs_10yr.MPCORB as mpc
    ...
    def test_jtrojans(self):
        expected_query = f"""SELECT a, e FROM dp03_catalogs_10yr.MPCORB as mpc
